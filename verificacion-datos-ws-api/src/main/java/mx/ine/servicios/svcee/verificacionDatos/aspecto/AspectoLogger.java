 ...
 */
package mx.ine.servicios.svcee.verificacionDatos.aspecto;
...
public class AspectoLogger {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AspectoLogger.class);

    private final int longitudMaximaCaracteres = 1000;
    private final String patternPackage = "mx.ine.serviciosconsulta.servicios.entidadesexternas..*";
